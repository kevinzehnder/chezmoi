				...
				settings = {
					yaml = {
						schemas = {
							...
							-- Kubernetes schemas
							["https://raw.githubusercontent.com/yannh/kubernetes-json-schema/master/v1.29.0-standalone-strict/all.json"] = "*.k8s.{yml,yaml}",
							...
							-- ArgoCD
							["https://raw.githubusercontent.com/argoproj/argo-cd/master/manifests/crds/application-crd.yaml"] = "*application*.{yml,yaml}",
							["https://raw.githubusercontent.com/argoproj/argo-cd/master/manifests/crds/appproject-crd.yaml"] = "*appproject*.{yml,yaml}",
						},
						validate = true,
						completion = true,
						hover = true,
